              ...
              children: [
                ScenarioSelectionItem(
                  onTap: ()
                  {
                    ...
                    image: Assets.educationalGoalImage, title: AppStrings.educationGoalTitleText),
                SizedBox(width: 15.0),
                ScenarioSelectionItem(image: Assets.explorationGoalImage, title: AppStrings.explorationGoalTitleText),
              ],
            ),
            SizedBox(height: 15.0),
            ScenarioSelectionItem(image: Assets.culturalGoalImage, title: AppStrings.culturalGoalTitleText),
          ],
        ),
      ),
    );
