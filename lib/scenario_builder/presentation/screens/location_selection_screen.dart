  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomizationBodyScreens(
        ...
        firstImage: Assets.colosseumLocationImage,
        firstTitle: AppStrings.colosseumRomanText,
        secondImage: Assets.pantheonLocationImage,
        secondTitle: AppStrings.pantheonRomanText,
        thirdImage: Assets.romanForumLocationImage,
        thirdTitle: AppStrings.romanForumRomanText,
        fourthImage: Assets.pompeiiLocationImage,
        fourthTitle: AppStrings.pompeiiRomanText,
      ),
    );
  }
}
